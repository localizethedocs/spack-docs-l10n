...
message(STATUS "Running 'python -m ensurepip' command to ensure the 'pip' package is installed...")
remove_cmake_message_indent()
message("")
execute_process(
...
set(REQUIREMENTS_TXT_PATH "${PROJ_OUT_REPO_DIR}/lib/spack/docs/requirements.txt")
